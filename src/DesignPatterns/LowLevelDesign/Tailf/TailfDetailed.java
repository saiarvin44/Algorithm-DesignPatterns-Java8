...
public class TailfDetailed implements Runnable {
    ...
    public TailfDetailed(String myFile, int myInterval) {
    ...
    public static void main(String argv[]) {
        ...
        String filePath = "/Users/saiarvind/Desktop/random.txt";
        TailfDetailed crunchify_tailF = new TailfDetailed(filePath, 2000);
